<!DOCTYPE html>
    ...
    <body>
        <div class="container">
            ...
            <h4 style="text-align: center">Sportcenter HealthOne</h4>
            <p style="text-align: center;">Fit en gezond zijn is geen vanzelfsprekendheid. We moeten er zelf wat voor doen. Goede, gezonde voeding is hiervoor de basis.
